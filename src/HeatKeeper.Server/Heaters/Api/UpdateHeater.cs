...
public record UpdateHeaterCommand(long HeaterId, string Name, string Description, string MqttTopic, string OnPayload, string OffPayload, HeaterState HeaterState) : PatchCommand;
