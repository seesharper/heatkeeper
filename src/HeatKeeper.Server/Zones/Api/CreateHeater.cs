...
public record CreateHeaterCommand(string Name, string Description, string MqttTopic, string OnPayload, string OffPayload, long ZoneId, bool Enabled = true) : PostCommand;
