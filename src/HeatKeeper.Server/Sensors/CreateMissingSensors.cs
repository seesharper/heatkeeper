...
public class CreateMissingSensors(IQueryExecutor queryExecutor, ICommandExecutor commandExecutor, TimeProvider timeProvider) : ICommandHandler<CreateMissingSensorsCommand>
{
